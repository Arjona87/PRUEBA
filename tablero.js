...
/* -------------------------------------------------------------------
   1. ARRANQUE Y GUARDAS
   Sin estas comprobaciones, un CDN bloqueado o un data.js truncado
   dejaban la página en blanco, sin ningún mensaje.
   ------------------------------------------------------------------- */
...
function pantallaDeFalla(titulo, detalle) {
  ...
  main.innerHTML =
    ...
    "<p>Si el problema persiste, revisa la consola del navegador y la ruta de los archivos " +
    "respecto de <code>index.html</code>.</p></div>";
...
if (typeof window.Chart === "undefined") {
  pantallaDeFalla(
    ...
    "Chart.js se sirve desde cdn.jsdelivr.net. Comprueba la conexión o descarga " +
      "chart.umd.js junto a los demás archivos y apunta la etiqueta <script> a la copia local."
  );
  return;
}
